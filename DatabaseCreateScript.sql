...
insert into equipment_items values
  (1, 'Automatic Level', 'Cairns', 'ROK 28/LG.01', 'Cab1-S4', 'Civil', 'leveling', null, null, 1),
  (2, 'Automatic Level tripod', 'Cairns', 'ROK 28/LG.01', 'Cab1-S2', 'Civil', 'leveling', null, null, 1),
  (3, 'Leica Total Station (S06 plus)', 'Cairns', 'ROK 28/LG.04', 'Cab1-S3', 'Civil', 'surveying, measurements', null, null, 1),
  (4, 'Leica Total Station (S06)', 'Cairns', 'ROK 28/LG.04', 'Cab1-S4', 'Civil', 'surveying, measurements', null, null, 1),
  (5, 'leica total Station tripod', 'Cairns', 'ROK 28/LG.04', 'Cab2-S1', 'Civil', 'surveying, measurements', null, null, 1),
  (6, 'GNSS Leica Receiver (GS14)', 'Cairns', 'ROK 28/LG.04', 'Cab2-S3', 'Civil', 'communications', null, null, 1),
  (7, '2 Tonne Bridge Crane', 'Cairns', 'ROK 28/LG.01', 'Cab3-S6', 'Civil', 'lifting', null, null, 1),
  (8, 'Flash Forge Creator 3 (FDM)', 'Melbourne', '6.25','Cab3-S3', 'Multi Purpose', '3D printing', null, 'https://www.flashforge.com/product-detail/1', 1),
  ...
  (16, 'Multimeters', 'Rockhampton', 'ROK 28/2.13','Cab5-S4', 'Multi Purpose', 'power, measurements', null, 'Standard lab induction', 1),
  (17, 'Power Supplies', 'Rockhampton', 'ROK 28/2.13','Cab6-S3', 'Multi Purpose', 'power, conversion', null, 'Standard lab induction', 1),
  (18, 'Sinterit Lisa Pro 3D Printer', 'Rockhampton','ROK 28/2.16', 'Cab1-S4', 'Multi Purpose', '3D printing', null, 'Standard lab induction', 1),
  (19, 'Funmat HT 3D Printer', 'Rockhampton', 'ROK 28/2.16','Cab2-S2', 'Multi Purpose', 'FFF, 3D printing', null, 'Standard lab induction', 1),
  (20, 'Metal 3D Printer x 2', 'Rockhampton', 'ROK 28/2.16','Cab3-S5', 'Multi Purpose', 'metal, 3D printing', null, 'https://www.sinterit.com/sinterit-lisa-pro/', 1),
  (21, 'Wash and Sinter II', 'Rockhampton', 'ROK 28/2.16','Cab5-S2', 'Multi Purpose', 'metal', null, 'https://markforged.com/3d-printers/metal-x', 1),
  (22, 'GoPro Hero 5 Black', 'Rockhampton', 'ROK 28/2.16','Cab1-S1', 'Multi Purpose', 'video', null, 'Standard lab induction', 1),
  (23, 'Sony RX100 Camera', 'Rockhampton', 'ROK 28/2.13','Cab6-S5', 'Multi Purpose', 'photography, video', null, 'https://www.sony.com.au/electronics/cyber-shot-compact-cameras/dsc-rx100', 1),
  (24, 'Desiccant Wheel', 'Bundaberg', 'G.15','Cab1-S4', 'Mechanical', 'rams project', null, null, 1),
  (25, 'Lab Volt MV Test equipment', 'Bundaberg', 'G.15','Cab2-S2', '', 'power', null, null, 1),
  (26, 'ETS7000 electronics breadboard and PS', 'Bundaberg', 'G.15','Cab3-S1', '', 'power', null, null, 1),
  (27, 'Power Supplies', 'Bundaberg', 'G.15','Cab2-S5', 'Electrical', 'power, conversion', null, null, 1),
  (28, 'Oscilloscopes', 'Bundaberg', 'G.15','Cab5-S2', 'Electrical', 'GUI, electrical signal', null, null, 1),
  (29, 'Oscillators', 'Bundaberg', 'G.15','Cab6-S3', 'Civil', 'power, current conversion', null, null, 1),
  (30, 'Multimeters', 'Bundaberg', 'G.15','Cab1-S5', 'Civil', 'power, measurements', null, null, 1),
  (31, 'Basic hydraulic test Bench', 'Melbourne', 'Room 3.22','Cab2-S4', 'Mechanical', 'hydraulics', null, null, 1),
  (32, 'Up box 3D printer', 'Melbourne', 'Room 3.22','Cab2-S6', 'Mechanical', '3D printing', null, null, 1),
  (33, 'UP box 3D printer mini', 'Melbourne', 'Room 3.22','Cab3-S1', 'Mechanical', '3D printing', null, null, 1),
  (34, 'Mitre saw', 'Melbourne', 'Room 3.22','Cab3-S4', 'Mechanical', 'sawing, angles', null, null, 1),
  (35, 'portable ladder', 'Melbourne', 'Room 3.22','Cab2-S8', 'Mechanical', 'accessibility', null, null, 1)
;

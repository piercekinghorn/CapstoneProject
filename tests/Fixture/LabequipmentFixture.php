...
class LabequipmentFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'equip_name' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
        ...
        'equip_status' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_constraints' => [
    ...
    public function init(): void
    {
        $this->records = [
            [
                'equip_id' => 1,
                'equip_name' => 'Lorem ipsum dolor sit amet',
